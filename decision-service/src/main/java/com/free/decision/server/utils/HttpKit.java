...
public class HttpKit {
	...
	public static String getGzip(String url, Map<String, String> queryParas, Map<String, String> headers) {
		HttpURLConnection conn = null;
		try {
			conn = getHttpConnection(buildUrlWithQueryString(url, queryParas), GET, headers);
			conn.connect();
			return readResponseGzipString(conn);
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	private static String readResponseGzipString(HttpURLConnection conn) {
		StringBuilder sb = new StringBuilder();
		InputStream inputStream = null;
		try {
			inputStream = conn.getInputStream();
			return new String(ZipUtil.unGzip(inputStream));
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
