 ...
 * 新颜行为雷达报告
 */
public class XyActionRadar implements Serializable {
    ...
    /**
     * 网络贷款类机构数:1-N表示命中查询主体贷款放款的消费金融类机构数(12个月内)
     */
    private Integer loansOrgCount;

    /**
     * 消费金融类机构数1-N表示命中查询主体贷款放款的消费金融类机
     */
    ...
    /**
     * 近1个月贷款机构失败扣款笔数 1-N表示命中查询主体的近一个月的贷款机构失
     */
    ...
    public Integer getConsfinOrgCount() { return consfinOrgCount; }

    public void setConsfinOrgCount(Integer consfinOrgCount) { this.consfinOrgCount = consfinOrgCount; }

    public Integer getLatestOneMonthFail() { return latestOneMonthFail; }

    public void setLatestOneMonthFail(Integer latestOneMonthFail) { this.latestOneMonthFail = latestOneMonthFail; }
